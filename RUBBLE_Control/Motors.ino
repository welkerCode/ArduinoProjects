...
// Callback functions
void left_motor_spd_cb( const std_msgs::Int16& cmd_msg){
  rc_left_spd(cmd_msg.data);
}

void right_motor_spd_cb( const std_msgs::Int16& cmd_msg){
  rc_right_spd(cmd_msg.data);
}
